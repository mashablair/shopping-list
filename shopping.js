...
// we need an array to hold our items -- STATE
let items = [];
...
function handleSubmit(e) {
  console.log(e.target); // entire shopping form
  e.preventDefault();
...
// since we just need it on page load, no need for event listener
